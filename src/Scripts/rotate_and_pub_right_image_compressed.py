''' 
    Purpose: Corrects right camera orientation
    Subscribed topics: /pylon_camera_node_right_infra/image_rect/compressed
    Pulished topic: /pylon_camera_node_right_infra/image_rect/flipped/compressed
